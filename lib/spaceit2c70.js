...
const spaceIt = (() => {
  ...
  const spacesUrl = "https://freecodescamp.github.io/spaces";
    ...
    let html = `
      <div id="spaceItLoginContainer">
        ...
        <div class="spaceit-modal-login-header">
          ...
          <h1>Save your code to<br class="w3-hide-large w3-hide-medium"> SpacesCode</h1>
        </div>
        <div>
  ...
  const showSaveCode = () => {
    ...
    let html = `
      <div id="spaceItSaveContainer">
        <h1>${user.data.spaces.length<=1 ? "Save your code to SpacesCode?" : "Save your code to SpacesCode?"}</h1>
