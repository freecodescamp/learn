var TopNavBar = {
  ...
  altProfileBaseUrl: 'http://w3schools.rf.gd',
...
TopNavBar._iframeInit = function () {
  window.addEventListener('message', function (message) {
    ...
    var whitelistedOrigins = [
      ...
      'https://freecodescamp.github.io/spaces',
...
TopNavBar.searchWithSuggestions = function (inp) {
  ...
  classAtt = "";
  if (html == "") classAtt = " search_active";
  html += '<button class="search_item' + classAtt + '" id="search-entire-w3schools-btn" style="border-top:1px solid #ddd;">CodesCamp Searchs</button>';
