function init_pagination() {
  ...
  if (activePage.indexOf(".html") == -1) {activePage = "<!-- default.html";}
  ...
  if (activePage == 1) {
    ...
    prevPage = "default_page" + (activePage - 1) + ".html";
  }
  if (activePage == pagescount) {
    nextPage = "default.html";
  } else {
    nextPage = "default_page" + (parseInt(activePage) + 1) + ".html";
  }
  for (i = 1; i <= pagescount; i++) {
    defPage = "default_page" + i + ".html";
    if (i == 1) {
